...
export const metadata: Metadata = {
  ...
  keywords: ['pincode finder', 'india pincode search', 'postal code india', 'find a pin code', 'zip code india', 'pincode', 'pin code', 'postal code', 'india pincode', 'post office india', 'pincode search', 'find pincode', 'pincode directory', 'post office near me', 'all india pincode', 'pincode by state', 'pincode by city', 'pincode by post office'],
