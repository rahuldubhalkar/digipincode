...
export async function generateMetadata({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }): Promise<Metadata> {
    ...
    return {
        title,
        description: `Find pincodes and post office details. Search results for state: ${state} and query: ${searchTerm}`,
        robots: {
            ...
            <Card>
                <CardHeader>
                    <CardTitle>
                     ...
                     {searchTerm && <CardDescription>Query: "{searchTerm}"</CardDescription>}
                </CardHeader>
                <CardContent>
